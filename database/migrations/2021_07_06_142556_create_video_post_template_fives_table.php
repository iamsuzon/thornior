...
class CreateVideoPostTemplateFivesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('video_post_template_fives', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('headline_outro')->nullable();
            $table->string('headline_outro_description')->nullable();
    ...
    {
        Schema::dropIfExists('video_post_template_fives');
    }
}
