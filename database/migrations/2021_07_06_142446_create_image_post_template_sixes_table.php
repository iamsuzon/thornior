...
class CreateImagePostTemplateSixesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('image_post_template_sixes', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('fimage');
            $table->string('fimage2');
            $table->string('fimage3');
    ...
    {
        Schema::dropIfExists('image_post_template_sixes');
    }
}
