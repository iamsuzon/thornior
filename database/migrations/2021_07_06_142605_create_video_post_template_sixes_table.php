...
class CreateVideoPostTemplateSixesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('video_post_template_sixes', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('outro_headline')->nullable();
    ...
    {
        Schema::dropIfExists('video_post_template_sixes');
    }
}
