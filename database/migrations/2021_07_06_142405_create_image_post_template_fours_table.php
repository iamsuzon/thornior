...
class CreateImagePostTemplateFoursTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('image_post_template_fours', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('image_post_template_fours');
    }
}
