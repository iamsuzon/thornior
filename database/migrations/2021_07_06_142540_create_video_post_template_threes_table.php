...
class CreateVideoPostTemplateThreesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('video_post_template_threes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('video_post_template_threes');
    }
}
