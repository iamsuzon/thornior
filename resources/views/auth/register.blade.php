...
{{--                                <div class="input-robot mb-4 border w-75 p-2 rounded border-1">--}}
...
{{--                                </div>--}}
                            ...
                            <ul class="nav mt-5" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a href="{{route('blogger.login.show')}}" class="nav-link" id="login-tab">
                                        Blogger Login
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a href="{{route('register')}}" class="nav-link active" id="signup-tab">
                                        Sign up
                                    </a>
                                </li>
                            </ul>
