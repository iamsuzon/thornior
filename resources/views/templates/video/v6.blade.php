    ...
    <div class="container">
        <div class="row gx-0">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-inner-space">
                        <img class="rounded" src="{{asset('upload/blogger_image_post')}}/{{$post['post']->image1}}" id="headline-one-image" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-5 col-md-5 offset-lg-2 offset-lg-2 col-sm-12 col-space">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-inner-space">
                        <img class="rounded" src="{{asset('upload/blogger_image_post')}}/{{$post['post']->image2}}" id="headline-two-image" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row gx-0">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-inner-space">
                        <img class="rounded" src="{{asset('upload/blogger_image_post')}}/{{$post['post']->image3}}" id="headline-three-image" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-5 col-md-5 offset-lg-2 offset-lg-2 col-sm-12 col-space">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-inner-space">
                        <img class="rounded" src="{{asset('upload/blogger_image_post')}}/{{$post['post']->image4}}" id="headline-four-image" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row gx-0">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-inner-space">
                        <img class="rounded" src="{{asset('upload/blogger_image_post')}}/{{$post['post']->image5}}" id="headline-five-image" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-5 col-md-5 offset-lg-2 offset-lg-2 col-sm-12 col-space">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-inner-space">
                        <img class="rounded" src="{{asset('upload/blogger_image_post')}}/{{$post['post']->image6}}" id="headline-six-image" alt="">
                    </div>
                </div>
            </div>
        </div>
