...
<div class="main-content">
    ...
    <!-- top navbar ends  -->
        ...
        <form action="{{route('blogger.blog.post.video.update.2',$post['post']->id)}}" method="POST"
                                ...
                                <div class="card-body">
                                    <div class="post-image">
                                        ...
                                        <p id="remove-cover-image" class="text-center" style="display: none;cursor: pointer"
                                           onclick="removeFeaturedImage(event)">Remove thumbnail image</p>
                                    </div>
                                    ...
                                    <div class="article-image mt-4">
                                        <div class="post-image">
                                            ...
                                            <p id="article_image_box_six" class="text-center"><img
                                                    src="{{asset('upload/blogger_image_post')}}/{{$post['post']->image6}}"
                                ...
                                <div class="card-body">
                                    <div class="post-image">
                                        ...
                                        <p class="text-center image-label" id="outro-image-label"><label for="outro-image-input"
                                                    ...
                                                    class="fas fa-camera"></i></label></p>
                                        <p id="image-box" class="text-center"><img
                                                src="{{asset('upload/blogger_image_post')}}/{{$post['post']->outro_image}}"
