...
<div class="main-content">
    ...
    <!-- top navbar ends  -->
        ...
        <form action="{{route('blogger.blog.post.video.update.1',$post['post']->id)}}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="post-left-nav-button d-inline-block float-start" style="margin-left: 20px">
                                <button type="submit" name="post_status" value="3" class="btn p-3" style="background-color: #fff">Save in Library</button>
                            </div>
                            <div class="post-right-nav-button d-inline-block float-end" style="margin-right: 20px">
                                <button type="submit" name="post_status" value="0" class="btn p-3" style="background-color: #fff">Preview</button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label for="formFile" class="form-label">Change video from here</label>
                            ...
                            <div class="card mt-4">
                                ...
                                <div class="card-body">
                                    <div class="post-image">
                                        ...
                                        <p id="image-label" class="text-center image-label"><label for="cover-image-input"
