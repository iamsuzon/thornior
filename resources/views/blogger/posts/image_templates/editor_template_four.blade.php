...
<div class="main-content">
    ...
    <div class="content-right" id="contentWidth" style="margin-left: 0">
        ...
        <!-- second navbar start -->
        <form action="{{route('blogger.blog.post.image.store.4')}}" method="POST"
                                ...
                                <div class="card-body">
                                    <div class="headline-1">
                                        ...
                                        <input class="form-control" type="text" name="headline_1"
                                               id="headline_1"
                                               placeholder="Add Intro Heading" value="{{old('headline_1')}}">
                                    </div>
                                    <div class="first-description-box mt-2">
                                                <textarea class="form-control" name="description_1"
                                                          id="description_1" rows="4"
                                                          placeholder="Describe in details">{{old('description_1')}}</textarea>
                                    </div>
                                    <div class="post-image">
