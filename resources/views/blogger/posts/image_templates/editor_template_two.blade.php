                                ...
                                <div class="card-body">
                                    <div class="post-image">
                                        ...
                                        <p id="image-box" class="text-center"><img
                                                src="{{asset('backend/assets/images/banner/profile/01.jpg')}}"
                                                id="cover-image-file"
                                                width="100%"/>
                                        </p>
                                ...
                                <div class="card-body">
                                    <div class="headline-1">
                                        ...
                                        <input class="form-control" type="text" name="intro_heading"
                                               id="first-headline"
                                               placeholder="Add Intro Heading" value="{{ old('intro_heading') }}">
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="head-1 mt-4">
                                        ...
                                        <input class="form-control" type="text" name="headline_4"
                                               id="headline_4"
                                               placeholder="Add Headline 04" value="{{ old('headline_4') }}">
                                    </div>
                                    <div class="des-1 mt-2">
                                    ...
                                    <div class="head-1 mt-4">
                                        ...
                                        <input class="form-control" type="text" name="headline_5"
                                               id="headline_5"
                                               placeholder="Add Headline 05" value="{{ old('headline_5') }}">
                                    </div>
                                    <div class="des-1 mt-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="last-description-box mt-2">
                                            <textarea class="form-control" id="last-description"
                                                      ...
                                                      placeholder="Describe in details"
                                                      rows="4">{{ old('outro_heading') }}</textarea>
                                    </div>
                                </div>
                            </div>
