...
<div class="main-content">
    ...
    <div class="content-right" id="contentWidth" style="margin-left: 0">
        ...
        <!-- second navbar start -->
        <form action="{{route('blogger.blog.post.image.update.6',$post['post']->id)}}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="post-image mt-4">
                                        ...
                                        <p id="image-box2" class="text-center"><img
                                                src="{{asset('upload/blogger_image_post')}}/{{$post['post']->fimage2}}"
                                    ...
                                    <div class="post-image mt-4">
                                        ...
                                        <p id="image-box3" class="text-center"><img
                                                src="{{asset('upload/blogger_image_post')}}/{{$post['post']->fimage3}}"
