...
<div class="main-content">
    ...
    <div class="content-right" id="contentWidth" style="margin-left: 0">
        ...
        <!-- second navbar start -->
        <form action="{{route('blogger.blog.post.image.update.4',$post['post']->id)}}" method="POST"
                ...
                <div class="container-fluid mt-5">
                    ...
                    <div class="row">
                        <div class="col-lg-9 col-md-9 col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    @include('layouts.templates.image.v4')
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12">
                                ...
                                <div class="card-body">
                                    <div class="headline-1">
                                        ...
                                        <input class="form-control" type="text" name="headline_1"
                                               id="headline_1"
                                               placeholder="Add Intro Heading" value="{{$post['post']->headline1}}">
                                    </div>
                                    <div class="first-description-box mt-2">
                                                <textarea class="form-control" name="description_1"
                                                          id="description_1" rows="4"
                                                          placeholder="Describe in details">{{$post['post']->description1}}</textarea>
                                    </div>
                                    <div class="post-image">
                                        <p><input type="file" accept="image/*" name="main_article_image_1" id="main-image-one-input"
                                    ...
                                    <div class="post-image mt-4">
                                        <p><input type="file" accept="image/*" name="main_article_image_2" id="main-image-two-input"
                            ...
                            <div class="card mt-4">
                                <div class="card-body">
                                    <div class="middle-image">
                                        <div class="post-image">
                                            <p><input type="file" accept="image/*" name="main_article_image_3" id="main-image-three-input"
                                    ...
                                    <div class="middle-image mt-4">
                                        <div class="post-image">
                                            <p><input type="file" accept="image/*" name="main_article_image_4" id="main-image-four-input"
                            ...
                            <!--NO NEED TO DO THIS PART - Last 3 images-->
                            <div class="card mt-4">
                                <div class="card-body">
                                    <div class="post-image">
                                        <p><input type="file" accept="image/*" name="bottom_image_1" id="last-image-input-one"
                                                  onchange="loadImage1(event)" style="display: none;"></p>
                                        <p class="text-center image-label" id="last-image-label1"><label for="last-image-input-one"
                                                                                                         style="cursor: pointer;"><i
                                                    class="fas fa-camera"></i></label></p>
                                        <p id="last-image-box1" class="text-center"><img
                                                src="{{asset('upload/blogger_image_post')}}/{{$post['post']->bottom_image1}}"
                                    ...
                                    <div class="post-image mt-5">
                                        <p><input type="file" accept="image/*" name="bottom_image_2" id="last-image-input-two"
                                                  onchange="loadImage2(event)" style="display: none;"></p>
                                        <p class="text-center image-label" id="last-image-label2"><label for="last-image-input-two"
                                                                                                         style="cursor: pointer;"><i
                                                    class="fas fa-camera"></i></label></p>
                                        <p id="last-image-box2" class="text-center"><img
                                                src="{{asset('upload/blogger_image_post')}}/{{$post['post']->bottom_image2}}"
                                    ...
                                    <div class="post-image mt-5">
                                        <p><input type="file" accept="image/*" name="bottom_image_3" id="last-image-input-three"
                                                  onchange="loadImage3(event)" style="display: none;"></p>
                                        <p class="text-center image-label" id="last-image-label3"><label for="last-image-input-three"
                                                                                                         style="cursor: pointer;"><i
                                                    class="fas fa-camera"></i></label></p>
                                        <p id="last-image-box3" class="text-center"><img
                                                src="{{asset('upload/blogger_image_post')}}/{{$post['post']->bottom_image3}}"
                                                id="last-image-file-three" width="100%"/>
                                        </p>
                                        <p id="remove-last-image3" onclick="removeImage3(event)"
                                           style="display: none; cursor: pointer;text-align: center">Remove
                                            third image</p>
                                    </div>
                                </div>
...
<script>
    ...
    var mainImageOne = function (event) {
        ...
        var imageShowOne = document.getElementById('heading-image1');
    ...
    var mainImageTwo = function (event) {
        ...
        var imageShowTwo = document.getElementById('heading-image2');
    ...
    var mainImageThree = function (event) {
        ...
        var imageShowThree = document.getElementById('heading-image3');
    ...
    var mainImageFour = function (event) {
        ...
        var imageShowFour = document.getElementById('heading-image4');
    ...
    var removeMainImageFour = function (event) {
        ...
        mainImageFour.src = "{{asset('backend/assets/images/blog/placeholder.jpg')}}";
    ...
    var loadImage1 = function (event) {
        ...
        var lastImageShowOne = document.getElementById('last_image_one');
    ...
    var loadImage2 = function (event) {
        ...
        var lastImageShowTwo = document.getElementById('last_image_two');
    ...
    var loadImage3 = function (event) {
        // add image
        var imageLastThree = document.getElementById('last-image-file-three');
        imageLastThree.src = URL.createObjectURL(event.target.files[0]);
        document.getElementById('last-image-label3').style.display = 'none';
        document.getElementById('remove-last-image3').style.display = 'block';

        var lastImageShowThree = document.getElementById('last_image_three');
        lastImageShowThree.src = URL.createObjectURL(event.target.files[0]);
    };

    // remove image
    var removeImage3 = function (event) {
        var lastImageInputThree = document.getElementById('last-image-input-three');
        lastImageInputThree.value = "";
        var imageLastThree = document.getElementById('last-image-file-three');
        imageLastThree.src = "";

        var lastImageShowThree = document.getElementById('last_image_three');
        lastImageShowThree.src = "{{asset('backend/assets/images/blog/placeholder.jpg')}}";

        document.getElementById('last-image-label3').style.display = 'block';
        document.getElementById('remove-last-image3').style.display = 'none';
    }
