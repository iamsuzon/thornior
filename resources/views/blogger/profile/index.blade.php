    ...
    <section class="blogger-profile">
        <div class="container">
            <div class="section-header">
                <h3><i class="fa fa-angle-left me-2"></i> My Profile</h3>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-5 col-12">
                        <div class="profiler-thumble">
                            ...
                            <form action="{{route('blogger.settings.profile.image.submit')}}" method="POST" id="profileImageForm" enctype="multipart/form-data">
                                @csrf
                                <div class="post-image">
                                    <p><input type="file" accept="image/*" name="image" id="file"
                                              onchange="profileImage(event)" style="display: none;"></p>
                                    <p id="image-box"><img src="@if(($bloggerData['blogger']->image) != 'user.jpg') {{asset('upload/blogger/avatar')}}/{{$bloggerData['blogger']->image}} @else {{asset('backend/assets/images/blog/placeholder.jpg')}} @endif"
                                ...
                                <button class="btn text-white" id="profileImageFormButton" type="submit" style="display: none">Upload</button>
                            </form>
                        ...
                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <button class="nav-link active" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="true"><i class="fa fa-home me-1"></i> My Profile</button>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-12">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" id="fName" name="name" class="form-control" placeholder="{{Auth::user()->name}}" value="{{$bloggerData['blogger']->name}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="input-group mb-3">
                                                        <label for="userEmail">Email</label>
                                                        <input type="email" id="userEmail" name="email" class="form-control" placeholder="{{Auth::user()->email}}" value="{{$bloggerData['blogger']->email}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                ...
                                                <div class="col-12">
                                                    <div class="input-group mb-4">
                                                        ...
                                                        <textarea name="about" id="" cols="30" rows="10">{{$bloggerData['blogger']->about}}</textarea>
                                                    </div>
                                                </div>
