                                ...
                                <table class="table">
                                    ...
                                    @forelse($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <form class="d-inline-block" action="{{route('users.store')}}" method="POST">
                                                        @csrf
                                                        <input type="hidden" name="id" value="{{$user->id}}">
                                                        <button type="submit" value="approve" name="action" class="btn btn-success btn-sm">Approve</button>
                                                    </form>
                                                    <form class="d-inline-block" action="{{route('users.store')}}" method="POST">
                                                        @csrf
                                                        <input type="hidden" name="id" value="{{$user->id}}">
                                                        <button type="submit" value="decline" name="action" class="btn btn-danger btn-sm">Decline</button>
                                                    </form>
                                                </div>
                                            </td>
                                        </tr>
